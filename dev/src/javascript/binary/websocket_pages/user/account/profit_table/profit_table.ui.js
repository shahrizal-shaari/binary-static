var ProfitTableUI = (function(){
    ...
    function createProfitTableRow(transaction){
        ...
        var data = [profit_table_data.buyDate, '<span' + showTooltip(profit_table_data.app_id, oauth_apps[profit_table_data.app_id]) + '>' + profit_table_data.ref + '</span>', jpClient ? format_money_jp(TUser.get().currency, profit_table_data.payout) : profit_table_data.payout , '', format_money_jp(TUser.get().currency, profit_table_data.buyPrice), profit_table_data.sellDate, format_money_jp(TUser.get().currency, profit_table_data.sellPrice) , format_money_jp(TUser.get().currency, profit_table_data.pl), ''];
